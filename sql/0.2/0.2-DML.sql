...
INSERT INTO `account_ticketingMessages` (
	...
	1, 'Re: Test title 1 lol & noob "', 2, '2015-08-10 09:46:02', 'Here''s a reply to that message!', 'almighty', 0, '127.0.0.1', 2, 'gigi', 1
), (
	2, 'Help!', 1, '2015-08-10 10:22:30', 'Pls help acc stolen omg', 'balance', 0, '127.0.0.1', 3, 'gigi', 1
), (
	2, 'Re: Help!', 2, '2015-08-10 10:24:20', 'Can you maybe elaborate more, please?', 'gigi', 1, '127.0.0.1', 1, 'balance', 1
);