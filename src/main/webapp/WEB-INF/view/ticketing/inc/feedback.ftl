...
<div class="frame center">
	...
	<#else>
		...
		<form method="post" action="${url('ticketing', feedbackLink, true)}" autocomplete="off">
			...
			<textarea id="inputProblem" name="inputProblem" maxlength="400" style="width: 500px; height: 242px; background-color: #000000; color: #FFFFFF; border-color: #444444;"></textarea><br /><br />
